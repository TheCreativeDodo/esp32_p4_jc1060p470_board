...
static const jd9165_lcd_init_cmd_t s_jd9165_init_cmds[] = {
...
static void bsp_audio_codec_power_enable(void)
{
    gpio_config_t power_pin_cfg = {
    ...
    ESP_ERROR_CHECK(gpio_config(&power_pin_cfg));
...
/* This configuration is used by default by audio player helper initialization */
...
esp_err_t bsp_display_new_with_handles(const bsp_display_config_t *config, bsp_lcd_handles_t *ret_handles)
{
    ...
    bsp_display_config_t default_config = {
    ...
    jd9165_vendor_config_t vendor_config = {
        .init_cmds = s_jd9165_init_cmds,
        .init_cmds_size = sizeof(s_jd9165_init_cmds) / sizeof(s_jd9165_init_cmds[0]),
        .mipi_config = {
    ...
    ESP_GOTO_ON_ERROR(esp_lcd_new_panel_jd9165(io, &lcd_dev_config, &disp_panel), err, TAG,
                      "New LCD panel JD9165 failed");
...
{
    assert(cfg != NULL);
    BSP_ERROR_CHECK_RETURN_NULL(bsp_display_new_with_handles(NULL, &disp_handles));
