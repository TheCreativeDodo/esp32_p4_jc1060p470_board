...
/**
 * @file
 * @brief ESP BSP: ESP32-P4 JC1060P470 Board
 */
 ...
 *  @{
 */
#define BSP_BOARD_ESP32_P4_JC1060P470_BOARD
#define BSP_BOARD_ESP32_P4_FUNCTION_EV_BOARD BSP_BOARD_ESP32_P4_JC1060P470_BOARD
/** @} */ // end of boardname
...
#define BSP_CAMERA_DEVICE       ("mipi_csi")
